...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Family Therapy',             href: '/service-details', description: 'Improve family relationships, resolve conflicts, and build a healthy living environment.' },
      { label: 'Child & Adolescent Therapy', href: '/service-details', description: 'Specialized support for children and teens, helping them navigate emotional challenges.' },
      { label: 'Group Therapy',              href: '/service-details', description: 'Join others with similar challenges, sharing experiences and support in a guided group setting.' },
      { label: 'Couples Therapy',            href: '/service-details', description: 'Enhance understanding affection between couples, helping to strengthen the relationship.' },
      { label: 'Trauma Counseling',          href: '/service-details', description: 'Focused therapy to help you heal from past trauma and regain control over your life.' },
      { label: 'Individual Counseling',      href: '/service-details', description: 'Personal psychological support to help you overcome stress, anxiety, and regain confidence.' },
    ],
    whatsNew: [
  ...
  return (
    <>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              {[
                ...
                <Box
                  ...
                  component="a"
                  href={s.href}
                  sx={{ color: 'text.secondary', display: 'flex', alignItems: 'center', transition: 'color 0.2s', '&:hover': { color: 'primary.dark' } }}
                >
                  {s.icon}
                </Box>
              ))}
        ...
        <Container maxWidth="lg">
          <Toolbar disableGutters sx={{ height: { xs: 64, md: 72 }, gap: 2 }}>
            ...
            <Box
              component={Link}
              href="/"
              sx={{ display: 'flex', alignItems: 'center', gap: 1, textDecoration: 'none', flexShrink: 0, mr: { xs: 'auto', md: 5 } }}
            >
              <Box sx={{ position: 'relative', width: 36, height: 36 }}>
                <Image src={logoSrc} alt={logoAlt} fill style={{ objectFit: 'contain' }} />
              </Box>
              <Typography
                sx={{ fontSize: 22, fontWeight: 400, fontFamily: '"DM Serif Display", serif', color: 'text.primary', letterSpacing: '-0.01em' }}
              >
                Healingy
              </Typography>
            </Box>
            ...
            <Box
              component="nav"
              sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', gap: 0.5, flex: 1 }}
            >
              {NAV_ITEMS.map((item) => (
                <Box
                  key={item.label}
                ...
                >
                  <Box
                    ...
                    sx={{
                      ...
                      whiteSpace: 'nowrap',
                      // underline on active
                      borderBottom: isActive(item.href) ? `2px solid ${theme.palette.text.primary}` : '2px solid transparent',
                      '&:hover': {
                        color: 'text.primary',
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 0.5, md: 1 } }}>
              <IconButton size="small" sx={{ color: 'text.secondary', '&:hover': { color: 'text.primary' } }} aria-label="Search">
                <SearchIcon />
              </IconButton>
      ...
      >
        ...
        >
          <Typography sx={{ fontSize: 20, fontWeight: 400, fontFamily: '"DM Serif Display", serif', color: 'text.primary' }}>
            Healingy
          </Typography>
            ...
            <Box key={item.label}>
              <ListItem disablePadding>
                <ListItemButton
                  ...
                  sx={{ borderRadius: '10px', px: 2, py: 1, '&:hover': { bgcolor: alpha(theme.palette.primary.main, 0.08) } }}
                >
                  <ListItemText
                    primary={item.label}
              ...
              {item.children?.map((child) => (
                <ListItem key={child.label} disablePadding sx={{ pl: 2 }}>
                  <ListItemButton
                    ...
                    sx={{ borderRadius: '10px', px: 2, py: 0.75, '&:hover': { bgcolor: alpha(theme.palette.primary.main, 0.08) } }}
                  >
                    <ListItemText
                      primary={child.label}
