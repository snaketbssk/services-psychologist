...
export default function PsychologistProfile({
  avatar = 'https://taplink.st/a/8/e/0/d/96f69f.png?6',
  username = 'elena_psy_online',
  name = 'Елена Дзюба',
  role = 'Психолог',
  tagline = 'Помогаю жить лучше, легче, приятнее — с самими собой, с другими людьми, с миром.',
  ...
  return (
    // Outer wrapper: linen bg, centers the narrow card, height = auto (content-driven)
    <Box
      component='section'
      sx={{
    ...
    >
      {/* Narrow card column — 480px max, same proportions as the screenshot */}
      <Box
        sx={{
          width: '100%',
          maxWidth: 480,
      ...
      >
        ...
        >
          {/* Peach banner */}
          <Box sx={{ bgcolor: '#FAD9C0', height: 90 }} />
          ...
          >
            ...
            {/* Username */}
            <Typography sx={{ fontSize: 12, color: 'text.secondary', letterSpacing: '0.04em', mb: 0.5 }}>
              {username}
            </Typography>
            ...
            <Divider sx={{ borderColor: 'grey.300', width: '100%', mb: 2.25 }} />
          ...
          {accordionItems.map((item, i) => (
            ...
            >
              ...
              <AccordionDetails sx={{ px: '20px', pt: 0, pb: 2.5 }}>
                <Typography sx={{ fontSize: 14, color: 'text.secondary', lineHeight: 1.75 }}>{item.content}</Typography>
              </AccordionDetails>
            </StyledAccordion>
          ))}
        </Box>
          ...
          {socialButtons.map((btn, i) => (
            ...
            >
              ...
              <Box sx={{ textAlign: 'center' }}>
                <Typography
                  sx={{ fontSize: 14, fontWeight: 600, color: 'inherit', lineHeight: 1.2, letterSpacing: '0.02em' }}
                >
                  {btn.label}
                </Typography>
                {btn.sublabel && (
