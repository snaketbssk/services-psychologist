  ...
  return (
    <Box>
      ...
      >
        ...
        <Divider />
        <MenuItem onClick={() => handleSelect('/realtor/application')}>{t('REALTOR.MENU.APPLICATION')}</MenuItem>
        <MenuItem onClick={() => handleSelect('/realtor/real-estate-create')}>
          {t('REALTOR.MENU.REAL_ESTATE_CREATE')}
        </MenuItem>
        <MenuItem onClick={() => handleSelect('/realtor/real-estates')}>{t('REALTOR.MENU.REAL_ESTATES')}</MenuItem>
        <MenuItem onClick={() => handleSelect('/realtor/real-estates-imports')}>{t('REALTOR.MENU.IMPORT')}</MenuItem>
        <Divider />
...
export default HeaderMenuRealtor
